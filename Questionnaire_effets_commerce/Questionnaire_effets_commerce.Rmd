...
mon_graph <- table |> 
    ...
    labs(x = "Population", y = "Pourcentage des commerces", linetype = "",
         ...
         title = stringr::str_wrap("Le nombre d'habitants des villes influence peu la fréquence de discussions privées", width = 45)) +
    theme_classic() +
    custom_theme() +
    theme(legend.position = "top",
          legend.title = ggplot2::element_text(family = font, size = 16, color = "#222222"),
...
mon_graph <- viz_liensocial_frequence_confidence(data, "Près de 7 commerçants sur 10 ont des discussions privées avec leurs clients au moins une fois par semaine")
mon_graph
saveWidget(girafe(print(mon_graph), width_svg = 7), 
...
mon_graph <- table |> 
    ...
    labs(x = "", y = "Nombre de commerces", linetype = "",
         ...
         title = stringr::str_wrap("Expliquer et détailler ses produits est le quotidien de plus de 7 commerçants sur 10", width = 45)) +
    geom_label(aes(x = Var, y = n+0.1*max(n), label = ifelse(is.na(percent), NA, paste0(round(percent, 0), "%"))),
               size = 5, fill = "white", label.size = NA) +
    theme_classic() +
    custom_theme() +
...
mon_graph <- viz_liensocial_associations(data, "Les <span style='color: #3182BD'>associations de quartier</span> sont les principales <br>associations avec lesquelles les commerçants <br>s'associent") +
...
viz_liensocial_techniquestra <- function(donnees, title_name){
    ...
    val2 |> 
      ...
      ggplot(aes(x="", y=n, fill=`Utilisez-vous des techniques traditionnelles et/ou artisanales pour fabriquer vos produits ?`,
                 tooltip = ifelse(n == 1, 
                                  paste("Utilisation", `Utilisez-vous des techniques traditionnelles et/ou artisanales pour fabriquer vos produits ?`, ":", n, "commerce"), 
                                  paste("Utilisation", `Utilisez-vous des techniques traditionnelles et/ou artisanales pour fabriquer vos produits ?`, ":", n, "commerces")))) +  
          geom_bar_interactive(stat="identity", width=1, color="white", size = 2) +
          coord_polar("y") +
          scale_fill_manual(values = c("Oui" = "#3182bd", "Non" = "#9ecae1")) +
          ...
          theme(legend.position = "top",
                ...
                plot.title.position = "plot", 
                plot.caption.position = "plot",
                plot.margin = ggplot2::margin(0, 0, 0, -190)) +
...
mon_graph <- viz_liensocial_techniquestra(data, "Utilisation de techniques traditionnelles ou artisanales chez les commerçants fabriquant les produits qu'ils vendent")
mon_graph
saveWidget(girafe(print(mon_graph)), 
...
mon_graph <- viz_solidarites_redirection(data, "Le <span style='color: #3182BD'>social</span> est le principal type de service <br>vers lequel les commerçants orientent")
mon_graph
saveWidget(girafe(print(mon_graph)), 
...
mon_graph <- table |> 
  ...
  ggplot() + 
    ...
    labs(x = "", y = "Nombre de commerces", linetype = "",
         title = str_wrap("Un quart des commerçants recommande et adresse des clients à des commerces voisins", width = 40),
...
mon_graph <- viz_santesecu_frequence_accidents(data, "Plus de 8 commerçants sur 10 commerces ont déjà été confrontés à des situations d'urgence", "")
mon_graph
#girafe(print(mon_graph))
...
mon_graph <- viz_environnement_discu_envt(data, "Un tiers des commerçants a des discussions informelles avec ses clients sur l'environnement") +
...
mon_graph <- table |> 
    ...
    labs(x = "", y = "Nombre de commerces", linetype = "",
         ...
         title = stringr::str_wrap("Plus de la moitié des commerçants a déjà interpellé les services de la mairie", width = 45)) +
    geom_label(aes(x = Var, y = n+0.1*max(n), label = ifelse(is.na(percent), NA, paste0(round(percent, 0), "%"))),
               size = 5, fill = "white", label.size = NA) +
    theme_classic() +
    custom_theme() +
...
viz_espacepublic_patrimoine <- function(donnees, title_name){
    ...
    table |> 
        ggplot(aes(x="", y=nb, fill=Var,
                   tooltip = paste(Var, ":", nb, "commerces"))) +  
          geom_bar_interactive(stat="identity", width=1, color="white", size = 2) +
          coord_polar("y") +
          scale_fill_manual(values = c("Oui" = "#3182bd", "Non" = "#9ecae1")) +
          labs(title = str_wrap(title_name, width = 33),
...
```{r}
mon_graph <- viz_liensocial_associations(paris, "À Paris, les <span style='color: #3182BD'>associations de quartier</span> sont les <br>principales associations avec lesquelles les <br>commerçants s'associent") +
...
```{r}
mon_graph <- viz_solidarites_redirection(paris, "À Paris, le <span style='color: #3182BD'>social</span> est le principal type de service <br>vers lequel les commerçants orientent")
mon_graph
saveWidget(girafe(print(mon_graph), width_svg = 7), 
...
```{r}
mon_graph <- viz_liensocial_associations(rouen, "À la Métropole Rouen Normandie, les <br><span style='color: #3182BD'>associations sociales</span> sont les principales <br>associations avec lesquelles les <br>commerçants s'associent") +
...
viz_solidarites_wordcloud_aides(rouen, "À la Métropole Rouen Normandie, l'accès aux toilettes et le don de nourriture / eau / café sont les actions les plus fréquentes des commerçants pour aider les personnes précaires")
```
...
```{r}
mon_graph <- viz_solidarites_redirection(rouen, "À la Métropole Rouen Normandie, le <span style='color: #3182BD'>social</span> est <br>le principal type de service vers lequel les <br>commerçants orientent")
mon_graph
saveWidget(girafe(print(mon_graph), width_svg = 7), 
