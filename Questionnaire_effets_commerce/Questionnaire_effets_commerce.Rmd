...
table |> 
  ggplot() +
      ...
      geom_treemap_text(aes(area = n, fill = Var, 
                            label = paste0(str_wrap(Var, width = 30), "\n(", n, " commerces)")),
                        colour = "white", place = "centre", size = 15, grow = TRUE) +
      scale_fill_manual(values = c("#345E68", "#afc7de", "#0C4C8A", "#9ecae1","#7A9BB1", "#3081bc", "#0C4C8A")) +
...
table |> 
  ggplot() +
      ...
      geom_treemap_text(aes(area = n, fill = Var, 
                            label = paste0(str_wrap(Var, width = 30), "\n(", n, " commerces)")),
                        colour = "white", place = "centre", size = 15, grow = TRUE) +
      scale_fill_manual(values = c("#345E68", "#afc7de", "#0C4C8A", "#9ecae1","#7A9BB1", "#3081bc", "#0C4C8A", "#345E68", "#afc7de", "#9ecae1","#7A9BB1", "#3081bc")) +
