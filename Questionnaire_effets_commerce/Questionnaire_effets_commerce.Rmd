...
fonction_stat_commune <- function(table, Externalité_texte, Indicateur_texte, nom_export){
    # Calcul de l'indicateur
    stat_commune <- table |> 
        select(variable_indic, Libelle_acheminement) |> 
...
fonction_stat_commune(table,
                      ...
                      nom_export = "solidarites_precaires")
...
fonction_stat_commune(table,
                      ...
                      nom_export = "solidarites_soin_gens")
...
fonction_stat_commune(table,
                      ...
                      nom_export = "solidarites_aide_ext")
...
table <- data |> 
    ...
    mutate(variable_indic = ifelse(`Avez-vous l'habitude de discuter avec vos clients en dehors du cadre strict de la vente ? (exemple : prendre des nouvelles personnelles)` == "Très régulièrement (plusieurs fois par jour)", "1", "0"))
    # Calcul de l'indicateur
fonction_stat_commune(table,
                      Externalité_texte = "Lien social", 
                      Indicateur_texte = "% de commerces ayant des discussions informelles plusieurs fois par jour avec leurs clients",
                      nom_export = "liensocial_socialiser")
...
fonction_stat_commune(table,
                      ...
                      nom_export = "liensocial_savoirs-faires")
...
fonction_stat_commune(table,
                      ...
                      nom_export = "liensocial_collab_asso")
...
fonction_stat_commune(table,
                      ...
                      nom_export = "viequartier_entreaide_co")
...
fonction_stat_commune(table,
                      ...
                      nom_export = "viequartier_entreaide_hab")
...
fonction_stat_commune(table,
                      ...
                      nom_export = "viequartier_contrib_attrac")

# 
    # Sélection des données
# table <- data |> 
#     filter(`` != "Je ne sais pas",
#            !is.na(``)) |> 
#     mutate(variable_indic = ifelse(`` == "Très régulièrement (plusieurs fois par jour)", "1", "0"))
#     # Calcul de l'indicateur
# fonction_stat_commune(table,
#                       Externalité_texte = "Vie de quartier", 
#                       Indicateur_texte = "% de commerces ",
#                       nom_export = "viequartier_")



#--- Compilation et affichage de la table
    # Compilation
stat_commune_finale <- do.call(bind_rows, mget(ls(pattern = "stat_commune_")))
    # Affichage
stat_commune_finale |> 
    select(-Catégorie) |> 
    ...
    tab_style(style = list(cell_text(weight = "bold")), locations = cells_body(columns = Indicateur)) |>  #en gras
    ...
    #tab_row_group(group = "Groupe A", rows = Externalité == "images/titre_lien_social.png") |> 
    gt_plt_bar_pct(`%`, scaled = TRUE, labels=TRUE, decimals = 0, #attention à remplacer les NA par 0 sinon erreur
                   font_size = "14px", fill = "#3182BD", height = 20) |> 
    gt_add_divider(Externalité, weight = px(2), color = "lightgrey")
```
