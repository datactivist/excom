...
mon_graph <- table |> 
    ggplot(aes(x="", y=nb, fill=`Êtes-vous indépendant ?`, 
               tooltip = paste("Indépendance", `Êtes-vous indépendant ?`, ":", nb, "commerces"))) +  
      ...
      theme(legend.position = "top",
            ...
            plot.title.position = "plot",
            plot.caption.position = "plot",
            plot.margin = ggplot2::margin(5, 0, 0, -170)) +
...
mon_graph <- table |> 
    ggplot(aes(x = "", y = nb, fill = `Travaillez-vous seul ?`,
               tooltip = paste("Travail seul", `Travaillez-vous seul ?`, ":", nb, "commerces"))) +  
      geom_bar_interactive(stat = "identity", width = 1, color = "white", size = 2) +
      coord_polar("y") +
      scale_fill_manual(values = c("Oui" = "#3182bd", "Non" = "#9ecae1")) +
      ...
      theme(legend.position = "top",
            ...
            plot.title.position = "plot", 
            plot.caption.position = "plot",
            plot.margin = ggplot2::margin(15, 0, 0, -190)
            ) +
