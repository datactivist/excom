...
```{r}
table <- data |> 
    filter(code_departement_partenaires == 76) |> 
...
## <FONT COLOR="#B4B1B1">Discussions privées avec les clients</FONT>
...
## <FONT COLOR="#B4B1B1">Explications approfondies sur les produits</FONT>
...
## <FONT COLOR="#004654">Sollicitations par des personnes en précarité
...
## <FONT COLOR="#004654">Discussions informelles avec les clients</FONT>
...
## <FONT COLOR="#004654">Redirections vers des aides extérieures</FONT>
...
## <FONT COLOR="#0097B2">Interventions dans des situations d'insécurité</FONT>
...
### <FONT COLOR="#0097B2">Analyse par taille de communes</FONT>{.tabset}
...
### <FONT COLOR="#0097B2">Analyse par catégorie de commerces</FONT>{.tabset}
...
## <FONT COLOR="#00A589">Intervention dans des situations d'insécurité</FONT>
...
## <FONT COLOR="#00A589">Aide aux personnes accidentées ou souffrantes</FONT>
...
## <FONT COLOR="#00A589">Situations d'insécurité des citoyens</FONT>
...
## <FONT COLOR="#FF5757">Interpellation des services de la mairie</FONT>
...
## <FONT COLOR="#FF5757">Nettoyage des abords du commerce</FONT>
