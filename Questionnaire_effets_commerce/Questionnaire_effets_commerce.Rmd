...
# Police du graphique
library(showtext)
font_add("Open Sans", regular = "fonts/OpenSans-VariableFont_wdth,wght.ttf")
showtext_auto()
...
mon_graph <- table |> 
    mutate(a_surligner = case_when(Var == "Jamais" ~ "1", 
                                   .default = "0")) |> 
    graph_questions_freq(ref_interpellation_mairie, "Plus de la moitié des commerçants a déjà interpellé les services de la mairie", 
                     "Répartition des commerces selon les interpellations des services de la mairie", "", "#3182bd") +
    labs(title = str_wrap("Plus de la moitié des commerçants a déjà interpellé les services de la mairie", width = 50)) +
    theme(plot.caption = element_blank(),
...
mon_graph <- viz_espacepublic_detail_partimoine(data, "Près d'un commerce sur trois porte une attention particulière à l'entretien de sa façade", 0.1)
mon_graph
#girafe(print(mon_graph))
saveWidget(girafe(print(mon_graph), width_svg = 7), 
