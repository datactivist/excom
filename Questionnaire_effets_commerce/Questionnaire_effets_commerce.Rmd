...
## Sous-populations par taille de communes
...
# On applique la fonction créée
graph_questions_freq2(table, ref_situations_precaires, "Ensemble des commerces", 
...
## Sous-populations par catégorie de commerces
...
graph_type_commerce_freq_agregee2(table, ref_data_freq_agregee, "Ensemble des commerces", 
                     "Répartition des commerces selon les interventions dans des situations d'insécurité", 15, "", "#3182bd") +
    theme(plot.caption = element_blank()) +
    geom_label(aes(x = Var, y = n+15, label = ifelse(is.na(percent), NA, paste0(round(percent, 0), "%"))),
               size = 5, fill = "white", label.size = NA)
```
...
graph_type_commerce_freq_agregee2(table, ref_data_freq_agregee, "Commerces alimentaires", 
                     "Répartition des commerces selon les interventions dans des situations d'insécurité", 1, "", "#3182bd")
```
