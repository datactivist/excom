...
# Application de la fonction
infographie_graph(paste0(round(val1$percent, 0), "%"), paste("des commerces dans les services aux particuliers n'ont jamais de discussions informelles avec leurs clients, soit", val1$ratio, "fois plus que l'ensemble des commerces"), 'fa-scissors',
