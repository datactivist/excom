...
mon_graph <- viz_environnement_discu_envt(data, "Un tiers des commerçants discute des enjeux environnementaux avec ses clients") +
...
```{r}
mon_graph <- viz_environnement_discu_envt(paris, "À Paris, 3 commerçants sur 10 ont des discussions informelles avec leurs clients sur l'environnement") +
...
```{r}
mon_graph <- viz_environnement_discu_envt(stouen, "À St Ouen, près de 3 commerçants sur 10 ont des discussions informelles avec ses clients sur l'environnement") +
...
```{r}
mon_graph <- viz_environnement_discu_envt(rouen, "À la Métropole Rouen Normandie, près de 4 commerçants sur 10 ont des discussions informelles avec ses clients sur l'environnement") +
